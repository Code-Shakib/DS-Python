import numpy as np # import statement allows us to access the functions and modules inside the function
...
height_arr = np.array(heights) # this code is excatly same as the upper code
